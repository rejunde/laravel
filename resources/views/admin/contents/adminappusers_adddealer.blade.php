  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header" data-background-color="green">
        <h4 class="title">Add Admin Users</h4>
      ...
      <div class="card-content">
        <div class="row">
          <div class="col-md-5">
            <div class="form-group label-floating" >
              <label class="control-label">Admin Fullname</label>
        ...
        <div class="row">
         ...
         <button type="button" id="save_admin_user" class="btn btn-primary pull-right">Save User</button>
