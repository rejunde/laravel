...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get()
        ;
        return view('front/contents/indexcontent',array('steps'=>json_decode(json_encode($getSteps),true)));
    }

    public function searchResult($searchdata,$filterdata){
        if($filterdata == "title"){
            $filter = 'book_details.bookdetails_title';
        }elseif ($filterdata == "author") {
            $filter = "book_details.bookdetails_author";
        }else{
            $filter = "faculty_user.faculty_fullname";
        }
